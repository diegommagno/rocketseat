...
routes.use("/notes", notesRouter); /* utilizar o arquivo users.routes, então quando chamar usersRouter vai para esse arquivo de grupo de rotas, que tem as rotas de users */
