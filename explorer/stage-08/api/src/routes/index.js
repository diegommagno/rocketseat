...
const notesRouter = require("./notes.routes"); /* importa o arquivo users.routes, então quando chamar usersRouter vai para esse arquivo de grupo de rotas, que tem as rotas de users */
const tagsRouter = require("./tags.routes"); /* importa o arquivo users.routes, então quando chamar usersRouter vai para esse arquivo de grupo de rotas, que tem as rotas de users */
